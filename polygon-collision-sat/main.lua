...
function love.update(dt)
	...
	overlap1, overlapSign = sat.checkCollision(poly1.vertices, poly2.vertices)
...
function love.draw()
	...
	love.graphics.print ('space to solve', 0,28)
end
...
function love.keypressed(key, scancode, isrepeat)
	...
	elseif key == "space" then
		if overlap1 then
			geometry.updatePolygon(poly1, overlap1.dx * overlapSign, overlap1.dy * overlapSign, 0)
		end
